  		...
  		$.ajax({
  			...
  			success:function(data){
  				...
  				$("#form2").append("<p><lable style='width:120px;text-align:right'>实验室序号：</lable><span id='csy110'>"+data.CSY110+"</span></p>"
	      				...
	      				+"<p><lable  style='width:120px;text-align:right'>周次：</lable>"+weekdata+"</p>"
	      				+"<p><lable  style='width:120px;text-align:right'>申请目的：</lable><input class='input' type='text' name='text' id='csy122'></p>"
