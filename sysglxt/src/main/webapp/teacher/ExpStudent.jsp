...
<html>
     ...
     <div>
    	<form id="form" method="post" action="">
    		...
    		<tr>
    			...
    			<th style="width:7%;text-align:center">学生姓名</th>
    			...
    			<th style="width:14%;text-align:center">附件</th>
    			<th style="width:14%;text-align:center">完成情况</th>
  ...
  <script type="text/javascript">
  	$(function (){
  		$.ajax({
  			type:'POST',
  			url:"${pageContext.request.contextPath}/teacher/queryStudentExp",
  			success:function(data){
  				...
  				for(var i=0;i<data.length;i++){
  					...
  					+"<td style='text-align:center'><input type='button' class='btn btn-primary btn-xs' value='详情' id='apply' onclick='openExp()'></td>"
  					+"</tr>");
  				};
  			}
  		})
