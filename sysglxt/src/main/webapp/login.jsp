    ...
    <div id="log_form" style="background-color:white;width:300px;height:350px;border:1px solid blue;margin-right:100px;margin-top:100px;float:right;font-family:'黑体';border-radius:0.5">    
        ...
        <form id="log_form">
          ...
          <div style="margin-left:42px">
            ...
            <label><input type="radio" name="usertype" value="0">管理员</label>
          </div>          
          <button  class="btn btn-default" type="submit"  style="font:20px;margin-left:50px;width:80px;margin-top:20px" onclick="login()"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style="top:2px"></span>登录</button>
...
<script type="text/javascript">
   function login(){
	   ...
	   $.ajax({
		   type:"POST",
		   url:"${pageContext.request.contextPath}/login/toLogin?username="+username+"&password="+password+"&csy010="+csy010,
